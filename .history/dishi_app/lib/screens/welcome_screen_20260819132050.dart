          ...
          child: Column(
            ...
            children: [
              ...
              AnimatedBuilder(
                ...
                child: Image.asset(
                  kFoodImageAssetPath, //Change image asset path to match the app's theme
                  height: 200,
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor:
                          backgroundColor, //Change button background color to match the app's theme
                      foregroundColor:
                          primaryColor, //Change button text color to match the app's theme
